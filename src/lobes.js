...
export const LOBES = [
  ...
  { id: 'insula', region: 'Insula', ko: '뇌섬엽', en: 'Insula', aliases: '섬엽 섬피질 도엽 insular lobe', color: '#819faf',
    ...
    note: 'BodyParts3D의 좌우 뇌섬엽 분할 형상입니다. 선택하면 덮개 피질을 투명하게 하여 안쪽 위치를 보여줍니다. 기존 바깥쪽 형상은 중심밑이랑·고랑으로 구분했습니다.',
    noteEn: 'Separate left and right insula segmentations from BodyParts3D. Selection makes the covering cortex transparent to reveal their deep location. The former outer surface is identified separately as subcentral gyrus and sulci.', source: insula },
