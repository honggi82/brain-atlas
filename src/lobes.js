...
export const LOBES = [
  { id: 'frontal', region: 'Frontal lobe', ko: '이마엽', en: 'Frontal lobe', aliases: '전두엽', color: '#ca9c85',
  ...
  { id: 'parietal', region: 'Parietal lobe', ko: '마루엽', en: 'Parietal lobe', aliases: '두정엽', color: '#c0af88',
    location: '중심고랑 뒤쪽, 뒤통수엽 앞쪽에 위치합니다.', locationEn: 'Posterior to the central sulcus and anterior to the occipital lobe.',
  ...
  { id: 'temporal', region: 'Temporal lobe', ko: '관자엽', en: 'Temporal lobe', aliases: '측두엽', color: '#bc9196',
  ...
  { id: 'occipital', region: 'Occipital lobe', ko: '뒤통수엽', en: 'Occipital lobe', aliases: '후두엽', color: '#9faaa0',
  ...
  { id: 'limbic', region: 'Limbic lobe', ko: '변연엽', en: 'Limbic lobe', aliases: '둘레엽', color: '#aa98b6',
    ...
    note: '원본 분류를 따라 해마는 여기에, 해마곁이랑은 관자엽에 표시합니다. 이 목록은 변연엽 전체를 빠짐없이 분할한 것이 아닙니다.',
