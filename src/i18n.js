...
const entries = {
  ...
  'Brain Project의 Z-Anatomy / BodyParts3D 모델에서 뇌 구조와 백질 경로 325개 형상을 선택했습니다. 좌우·세부 조각을 포함하며, 서로 다른 영문 이름은 174개입니다. 혈관·말초 뇌신경은 이 버전의 범위에서 제외했습니다.': 'The viewer selects 325 anatomical structures and white matter pathways from the Z-Anatomy / BodyParts3D-based Brain Project model. These include bilateral and subdivision entries with 174 distinct source labels. Blood vessels and peripheral cranial nerves are outside this version.',
  ...
  '174개 이름 · 325개 형상': '174 names · 325 structures',
